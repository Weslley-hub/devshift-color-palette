    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="max-w-5xl mx-auto px-6 py-16">
        ...
        <p className="text-muted-foreground mb-8">
          Inferno — Agressividade, energia e presença marcante.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="rounded-xl border border-border bg-card p-8">
            ...
            <p className="text-muted-foreground mt-2 text-sm">
              Títulos, CTAs e destaques visuais
            </p>
          </div>
          <div className="rounded-xl border border-border bg-card p-8">
            <span className="text-xs uppercase tracking-widest text-primary mb-4 block">
            ...
            <p className="text-muted-foreground mt-2 text-sm">
              Texto corrido, descrições e interface
            </p>
          </div>
        </div>
      </section>
      ...
      {/* <section className="max-w-5xl mx-auto px-6 py-16">
        <h2 className="text-3xl font-bold text-foreground mb-2">
          Conceitos de Logo — V2
        </h2>
        <p className="text-muted-foreground mb-8">
          Ícone + texto — 3 direções em vermelho & laranja
        </p>
        <div className="grid md:grid-cols-3 gap-6">
          {logos.map((logo, i) => (
            <div
              key={i}
              className="rounded-xl border border-border bg-card overflow-hidden group hover:border-primary/50 transition-colors"
            >
        ...
        <div className="mt-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {logos.map((logo, i) => (
              <div
                key={i}
                className="rounded-xl border border-border bg-muted flex items-center justify-center p-8"
              >
                <img
                  src={logo.src}
                  alt={`${logo.label} dark`}
      ...
      <section className="max-w-5xl mx-auto px-6 py-16">
        <h2 className="text-3xl font-bold text-foreground mb-2">
          Regras de Uso — Cores & Logo
        </h2>
        <p className="text-muted-foreground mb-8">
          Diretrizes para aplicação correta da marca em diferentes contextos.
        </p>

        {/* Uso correto */}
        <div className="mb-12">
          <h3 className="text-xl font-bold text-foreground mb-6 flex items-center gap-2">
            <span className="w-6 h-6 rounded-full bg-green-500/20 flex items-center justify-center text-green-400 text-xs">
              ✓
            </span>
            Uso Correto
          </h3>
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="rounded-xl border border-border overflow-hidden">
              ...
              <div className="p-4 bg-card">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Logo colorido sobre fundos #0d0d0d ou #171717. Uso principal.
                </p>
              </div>
            </div>
            {/* Fundo branco */}
            <div className="rounded-xl border border-border overflow-hidden">
              ...
              <div className="p-4 bg-card">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Logo colorido + texto escuro sobre fundos brancos ou claros.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-xl border border-border overflow-hidden">
              ...
              <div className="p-4 bg-card">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Logo branco sobre fundo Inferno Red. Ideal para CTAs e
                  banners.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-xl border border-border overflow-hidden">
              ...
              <div className="p-4 bg-card">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Logo branco sobre gradiente vermelho→laranja. Uso em peças de
                  destaque.
                </p>
              </div>
            </div>
        ...
        <div className="mb-12">
          <h3 className="text-xl font-bold text-foreground mb-6 flex items-center gap-2">
            <span className="w-6 h-6 rounded-full bg-destructive/20 flex items-center justify-center text-destructive text-xs">
              ✕
            </span>
            Uso Incorreto
          </h3>
            ...
            <div className="rounded-xl border border-destructive/30 overflow-hidden">
              ...
              <div className="p-4 bg-card">
                <p className="text-sm font-semibold text-destructive">
                  Fundos coloridos conflitantes
                </p>
                <p className="text-xs text-muted-foreground mt-1">
                  Nunca use sobre cores que competem com o vermelho/laranja.
                </p>
              </div>
            </div>
            <div className="rounded-xl border border-destructive/30 overflow-hidden">
              <div className="p-8 flex items-center justify-center bg-card">
                <span
                  className="text-2xl font-extrabold text-muted-foreground/30"
                  style={{ fontFamily: "var(--font-heading)" }}
                >
                  DevShift
                </span>
              ...
              <div className="p-4 bg-card">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Nunca aplique o logo com opacidade reduzida ou cores apagadas.
                </p>
              </div>
            </div>
            <div className="rounded-xl border border-destructive/30 overflow-hidden">
              <div className="p-8 flex items-center justify-center bg-card">
                <span
                  className="text-2xl font-extrabold text-foreground italic"
              ...
              <div className="p-4 bg-card">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Nunca substitua a fonte Syne por outra tipografia.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="rounded-xl border border-border bg-card p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <p className="text-sm font-semibold text-foreground">
                    Inferno Red — Primária
                  </p>
                  <p className="text-xs text-primary font-mono">#e63946</p>
                </div>
              </div>
              <p className="text-sm text-muted-foreground">
                Uso principal: logo, CTAs, botões primários, links ativos.
                Máximo 30% da composição.
              </p>
            </div>
            <div className="rounded-xl border border-border bg-card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <p className="text-sm text-muted-foreground">
                Uso secundário: ícones, badges, hovers, destaques. Sempre
                acompanhando o vermelho, nunca sozinho.
              </p>
            </div>
            <div className="rounded-xl border border-border bg-card p-6">
              <div className="flex items-center gap-3 mb-4">
              ...
              <p className="text-sm text-muted-foreground">
                Base principal de fundo. Domina 60-70% do layout. Transmite
                sofisticação.
              </p>
            </div>
            <div className="rounded-xl border border-border bg-card p-6">
              ...
              <p className="text-sm text-muted-foreground">
                Cards, modais e superfícies elevadas. Cria hierarquia visual
                sobre o fundo Obsidian.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-16 pb-24">
        ...
        <p className="text-muted-foreground mb-8">
          Ícones sugeridos para cada serviço
        </p>
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {services.map((s) => (
            <div
              key={s.name}
              className="rounded-xl border border-border bg-card p-6 flex items-center gap-4 hover:border-primary/50 transition-colors"
            >
